 ...
 * dịch). Một dòng import thật vào `./ChainBody` là kéo `LinkedInput` và cả
 * `InlineWarning` vào chunk chung của **cả 111 trang chi tiết**, trong khi đúng **5 công thức**
 * dùng tới nó (`wacc`, `mo-hinh-gordon`, `bien-an-toan`, `fcfe`, `gia-tri-noi-tai-fcff` — những
 * công thức NHẬN số từ công thức khác) và chỉ khi người dùng bật chế độ Nâng cao.
 *
 ...
 * `InlineWarning` vào TOÀN BỘ 111 trang thay vì chỉ 5 trang cần chúng chỉ làm vấn đề đã có thêm
 * nặng, không giúp gì.
 */
