...
const VISUALS: Readonly<Record<string, CategoryVisual>> = {
  ...
  returns: { path: 'M4 17l5-5 3 3 7-7', extra: 'M15 8h5v5' },
  // Tam giác cảnh báo — rủi ro.
  risk: { path: 'M12 4 2.5 20h19L12 4Z', extra: 'M12 10v4M12 16.8v.2' },
  ...
  derivatives: { path: 'M4 8h15M4 16h15', extra: 'M15 4l4 4-4 4M8 12l-4 4 4 4' },
  ...
  // Tờ khế ước — vay nợ.
  loans: { path: 'M5 3h9l5 5v13H5V3Z', extra: 'M14 3v5h5M9 13h6M9 17h4' },
