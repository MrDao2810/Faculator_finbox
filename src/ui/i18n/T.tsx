 ...
 *
 * Khung AppShell, kệ "Công thức dùng hằng ngày" hay màn Về chúng tôi cố ý là server component để
 * nhánh `tile` của FormulaCard và phần prose không lọt vào gói máy khách (NFR-PER-04) — chúng không
 * gọi hook được. Bọc ĐÚNG PHẦN CHỮ vào lá client này thì cả khối vẫn do server dựng, chỉ mỗi
