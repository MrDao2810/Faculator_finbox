 ...
 * build** và kết quả được nướng thẳng vào HTML tĩnh của 111 trang. Đó là toàn bộ lý do gói này
 ...
 *
 * 1. **Cả 111 chuỗi `latex` đều dựng được**, 0 lỗi, 0 cảnh báo ở `strict: false`.
 ...
 *    cả 111 chuỗi `latex`, `name.vi` và `expression` — không chuỗi nào lệch NFC. Chụp màn bằng
